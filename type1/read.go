...
creationDateLoop:
	...
	UnderlinePosition, _ := getReal(fontInfo["UnderlinePosition"])
	UnderlineThickness, _ := getReal(fontInfo["UnderlineThickness"])
	...
	for i, v := range fontMatrixArray {
		...
		UnderlinePosition:  funit.Float64(UnderlinePosition),
		UnderlineThickness: funit.Float64(UnderlineThickness),
