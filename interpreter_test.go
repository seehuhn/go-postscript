...
%!PS-AdobeFont-1.0: OpenSans-Regular 1.10
%%Title: OpenSans-Regular
%Version: 1.10
%%CreationDate: Mon Jun 24 21:54:13 2019
%%Creator: Mohamed El Morabity
%Copyright: Digitized data copyright (c) 2010-2011, Google Corporation.
% Generated by FontForge 20190217 (http://fontforge.sf.net/)
%%EndComments
10 dict begin
/FontType 1 def
/FontMatrix [0.000488281 0 0 0.000488281 0 0 ]readonly def
/FontName /OpenSans-Regular def
/FontBBox {-1126 -555 2466 2146 }readonly def
/PaintType 0 def
/FontInfo 10 dict dup begin
 /version (1.10) readonly def
 /Notice (Digitized data copyright \050c\051 2010-2011, Google Corporation.) readonly def
 /FullName (Open Sans Regular) readonly def
 /FamilyName (Open Sans) readonly def
 /Weight (Book) readonly def
 /FSType 0 def
 /ItalicAngle 0 def
 /isFixedPitch false def
 /UnderlinePosition -205 def
...
currentdict end
	...
	fmt.Println(len(intp.Stack))
	fmt.Println(len(intp.DictStack))
	fd := intp.Stack[len(intp.Stack)-1].(Dict)
